...
export function HeaderNav() {
  ...
  const handleLogout = () => {
    ...
    const confirmResult = confirm('Are you sure you want to logout?')
  ...
  return (
    <Navbar placeholder={''} className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
